      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <FadeIn>
          <SectionHeading
            ...
            description="Изграждаме цялостна платформа около вашия процес — от конфигурация до CNC-готови DXF файлове, с възможност да добавяте продукти. Първо довеждаме гардероба end-to-end; каталогът расте върху същата архитектура."
          />
        </FadeIn>
        ...
        <FadeIn delay={0.1}>
          <p className="mt-8 max-w-3xl border-l-2 border-ink/20 pl-5 text-sm leading-relaxed text-stone-600 md:text-base">
            ...
            продуктите, ценовите правила и производството на Forèsta. MVP
            старт с гардероб (включително BOM и DXF); платформата вече е готова
            за следващи продукти без смяна на системата.
          </p>
        </FadeIn>
