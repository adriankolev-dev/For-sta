      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <FadeIn>
          <SectionHeading
            ...
            description="Офертата включва платформата и възможността да разширявате каталога. След като гардеробът е валидиран end-to-end, по желание планираме по-дълбоки интеграции извън основния обхват."
          />
        </FadeIn>
