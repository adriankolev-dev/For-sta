...
export const MVP_RULES = [
  {
    title: "Офертата е цялостното решение",
    description:
      "€46 000 без ДДС покрива платформата и първия продукт: конфигуратор, поръчки, BOM и DXF за CNC. MVP е начинът на доставка — не по-малка оферта.",
  },
  {
    title: "MVP = един продукт за валидация",
    description:
      "Първо покриваме гардероба end-to-end — от конфигурация до производствени файлове — и валидираме модела в реална употреба.",
  },
  {
    title: "После добавяме останалото",
    description:
      "Допълнителни продукти се оценяват отделно и се добавят върху същата архитектура — без да строим платформата отначало.",
  },
] as const;
...
export const SCOPE_CLIENT = [
  "първи продукт за валидация — гардероб",
...
export const SCOPE_BUSINESS = [
  "управление на продукти (архитектура за разширяване)",
...
export const FUTURE_EXTENSIONS = [
  "допълнителни продукти върху същия файлов стандарт",
...
export const INCLUDED_ITEMS = [
  ...
  "Архитектура за допълнителни продукти",
...
export const EXCLUDED_ITEMS = [
  ...
  "множество продуктови категории в първата валидация (MVP)",
...
export const PRINCIPLES = [
  {
    number: "01",
    title: "Цялостно решение. MVP за валидация.",
    description:
      "Офертата е пълната платформа — включително BOM и DXF за CNC. В MVP валидираме всичко това върху един продукт (гардероб).",
  },
  {
    number: "02",
    title: "Един файлов стандарт",
    description:
      "Фиксираме един договорен формат за моделиране. Така визуализацията, BOM и DXF изходът остават стабилни при следващи продукти.",
  },
  {
    number: "03",
    title: "Разширяваме след валидиране",
    description:
      "Нови продукти се добавят върху същата архитектура — без да изграждаме клиентското изживяване и производствения изход наново.",
  },
] as const;
...
export const BUSINESS_VALUES = [
  ...
  },
  {
    ...
    description:
      "След валидация на гардероба нови продукти се добавят върху същата платформа.",
  },
] as const;
